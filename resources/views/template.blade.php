                ...
                <div class="col-lg-12">
                    <section class="tm-header-gallery">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 tm-pad-0">
                            <a href="{{asset('assett/img/img-21-01.jpg')}}">
                                <img src="{{asset('assett/img/img-21-01.jpg')}}" alt="Image" class="img-fluid tm-header-img">        
                            </a>                          
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 tm-pad-0">
                            <a href="{{asset('assett/img/img-21-03.jpg')}}">
                                <img src="{{asset('assett/img/img-21-03.jpg')}}" alt="Image" class="img-fluid tm-header-img">    
                            </a>                      
                        </div>                
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                    <div class="tm-about-box-2">
                        <img src="{{asset('assett/img/img-11-01.jpg')}}" alt="Image" class="img-fluid">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                    <div class="tm-about-box-2">
                        <img src="{{asset('assett/img/img-11-03.jpg')}}" alt="Image" class="img-fluid">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                    <div class="tm-about-box-2">
                        <img src="{{asset('assett/img/img-11-05.jpg')}}" alt="Image" class="img-fluid">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                    <div class="tm-about-box-2">
                        <img src="{{asset('assett/img/img-11-07.jpg')}}" alt="Image" class="img-fluid">
